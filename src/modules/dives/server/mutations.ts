...
export const diveEntryInputSchema = z.object({
  ...
  dive: z.object({
    ...
    safetyStop: z.boolean().default(false),
    safetyStopMinutes: formText,
    pressureGroupBeforeInterval: formText,
    pressureGroupAfterInterval: formText,
    pressureGroupEnd: formText,
    residualNitrogenMinutes: formText,
    waterType: formText,
    entryType: formText,
    visibility: formText,
    current: formText,
