    ...
    async (transaction) => {
      const [dive] = await transaction
        .select({
          ...
          pressureGroupBeforeInterval: dives.pressureGroupBeforeInterval,
          pressureGroupAfterInterval: dives.pressureGroupAfterInterval,
          pressureGroupEnd: dives.pressureGroupEnd,
          residualNitrogenSeconds: dives.residualNitrogenSeconds,
