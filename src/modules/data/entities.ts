...
export const entityDefinitions: Record<EntityKey, EntityDefinition> = {
  dives: {
    ...
    fields: [
      ...
      {
        key: 'legacyBuddyText',
        label: 'Legacy buddy note',
        kind: 'text',
        section: 'Relationships',
        help: 'Free-text buddy value from older DiveMate records.',
      },
      {
        key: 'buddyIds',
        label: 'Buddies',
  ...
  sites: {
    ...
    fields: [
      ...
      {
        key: 'sourceLatitude',
        label: 'Original source latitude',
        kind: 'text',
        section: 'Source coordinates',
        readOnly: true,
        help: 'The coordinate text received from DiveMate before normalization.',
      },
      {
        key: 'sourceLongitude',
        label: 'Original source longitude',
        kind: 'text',
        section: 'Source coordinates',
        readOnly: true,
        help: 'The coordinate text received from DiveMate before normalization.',
  ...
  buddies: {
    ...
    fields: [
      ...
      { key: 'email', label: 'Email', kind: 'email', section: 'Contact' },
      { key: 'phone', label: 'Phone', kind: 'tel', section: 'Contact' },
      { key: 'street', label: 'Street', kind: 'text', section: 'Location' },
      { key: 'postalCode', label: 'Postal code', kind: 'text', section: 'Location' },
      { key: 'city', label: 'City', kind: 'text', section: 'Location' },
      { key: 'state', label: 'State / province', kind: 'text', section: 'Location' },
      { key: 'country', label: 'Country', kind: 'text', section: 'Location' },
      { key: 'notes', label: 'Notes', kind: 'textarea', section: 'Notes' },
    ],
  },
  equipment: {
    ...
    fields: [
      ...
      { key: 'information', label: 'Information', kind: 'text', section: 'Identity' },
      { key: 'purchasedAt', label: 'Purchased', kind: 'date', section: 'Lifecycle' },
      {
        key: 'purchasePrice',
        label: 'Purchase price (source units)',
        kind: 'number',
        section: 'Purchase',
        min: 0,
        step: '0.01',
      },
      { key: 'purchaseShop', label: 'Purchase shop', kind: 'text', section: 'Purchase' },
  ...
  certifications: {
    ...
    fields: [
      ...
      {
        key: 'scan1Path',
        label: 'Front scan source path',
        kind: 'text',
        section: 'Scans',
      },
      {
        key: 'scan2Path',
        label: 'Back scan source path',
        kind: 'text',
        section: 'Scans',
      },
    ],
  ...
  tanks: {
    ...
    fields: [
      ...
      {
        key: 'computerTankNumber',
        label: 'Dive computer tank number',
        kind: 'number',
        section: 'Assignment',
        min: 1,
        step: '1',
        help: 'Matches pressure samples and tank switches recorded by the dive computer.',
      },
      {
        key: 'tankType',
  ...
  'profile-samples': {
    ...
    fields: [
      ...
      {
        key: 'pressureBar',
        label: 'Active tank pressure (bar)',
        kind: 'number',
        section: 'Measurement',
        min: 0,
        step: '0.01',
      ...
      {
        key: 'tankNumber',
        label: 'Active dive computer tank number',
        kind: 'number',
        section: 'Tank switch',
        min: 1,
        step: '1',
  ...
  'sync-runs': {
    ...
    fields: [
      ...
      {
        key: 'sourceDatabaseVersion',
        label: 'DiveMate database version',
        kind: 'text',
        section: 'Diagnostics',
        readOnly: true,
      },
      {
        key: 'sourceDatabaseProgram',
      ...
      {
        key: 'sourceDatabaseUuid',
        label: 'Source database UUID',
        kind: 'text',
        section: 'Diagnostics',
        readOnly: true,
      },
      {
        key: 'sourceDatabaseUpdatedAt',
        label: 'Source database updated',
        kind: 'text',
        section: 'Diagnostics',
        readOnly: true,
      },
