...
export const entityDefinitions: Record<EntityKey, EntityDefinition> = {
  ...
  'sync-runs': {
    ...
    singular: 'Import run',
    plural: 'Import runs',
    description: 'Immutable full and incremental import outcomes and diagnostics.',
    mutable: false,
    fields: [
      {
        key: 'integrationKey',
      ...
      { key: 'mode', label: 'Mode', kind: 'text', section: 'Run', readOnly: true },
