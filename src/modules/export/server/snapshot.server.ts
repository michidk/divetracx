  ...
  return getDb().transaction(
    async (transaction) => ({
      ...
      data: {
        ...
        buddyCertifications: await transaction.select().from(buddyCertifications),
        buddyAgencyMemberships: await transaction.select().from(buddyAgencyMemberships),
        ...
        boats: await transaction.select().from(boats),
